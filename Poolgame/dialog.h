...
public:
    explicit Dialog(Game* game, std::string stageFlag, QWidget *parent = 0);
    ~Dialog();
...
private:
     ...
     */
    Game* m_game = nullptr;
    std::string m_stageFlag = "StageOne";
    Memento* m_memento = nullptr;
    bool m_saveFlag = false;
    QColor m_cueBallColor = QColor("white");
    QColor m_cueBallColor2 = QColor("white");
};
